...
class EmailService {
  ...
  async sendWelcomeEmail(toEmail, userName) {
    if (!SendGridService.validateEmail(toEmail)) {
      throw new Error('Invalid email address');
    }

    return SendGridService.sendNotification({
      to: toEmail,
  ...
  async sendVerificationCodeEmail(toEmail, code) {
    ...
    return SendGridService.sendVerificationCodeEmail(toEmail, code, this.defaultSender);
  }
  ...
  setDefaultSender(senderEmail) {
    if (!SendGridService.validateEmail(senderEmail)) {
