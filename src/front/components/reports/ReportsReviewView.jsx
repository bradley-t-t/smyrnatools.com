                    ...
                    {report.name === 'general_manager' ? (
                        <>
                            <div style={{
                                ...
                                <div style={{
                                    ...
                                    {plants.map((plant, idx) => (
                                        ...
                                        >
                                            <div style={{ marginBottom: 6 }}>{plant.plant_name}</div>
                            ...
                            <div style={{
                                ...
                                {plants.map(plant => (
                                    <div key={plant.plant_code} style={{
                                        width: '100%',
                                        background: 'var(--background-elevated)',
                                        borderRadius: 18,
                                        ...
                                        <div style={{
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    type="number"
                                                    value={form[`runnable_trucks_${plant.plant_code}`] || ''}
                                                    readOnly
                                                    disabled
                                                    style={{
                                                        width: '100%',
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    type="number"
                                                    value={form[`operators_starting_${plant.plant_code}`] || ''}
                                                    readOnly
                                                    disabled
                                                    style={{
                                                        width: '100%',
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    type="number"
                                                    value={form[`operators_leaving_${plant.plant_code}`] || ''}
                                                    readOnly
                                                    disabled
                                                    style={{
                                                        width: '100%',
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    type="number"
                                                    value={form[`total_yardage_${plant.plant_code}`] || ''}
                                                    readOnly
                                                    disabled
                                                    style={{
                                                        width: '100%',
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    type="number"
                                                    value={form[`total_hours_${plant.plant_code}`] || ''}
                                                    readOnly
                                                    disabled
                                                    style={{
                                                        width: '100%',
                                        ...
                                        <div style={{
                                            ...
                                            <WeeklyGeneralManagerReportPlugin
                                                ...
                                                yardage={form[`total_yardage_${plant.plant_code}`]}
                                                hours={form[`total_hours_${plant.plant_code}`]}
                                            />
                                        </div>
                                    </div>
                                ))}
